...
void InputSystem::update(ComponentManager<InputComponent> &inputManager, const SDL_Event &event)
{
...
bool InputSystem::mapKeyToAction(SDL_Keycode key, InputAction &action)
{
    switch (key) {
